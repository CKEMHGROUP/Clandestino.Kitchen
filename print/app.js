...
// SECURE PRODUCTION ISOLATION ENGINE FOR CLANDESTINO.KITCHEN
function generatePerfectPDF() {
  const voucherHTML = document.getElementById('voucher-doc').innerHTML;
  
  // Open a clean staging window matching your exact aspect boundary limits
  ...
  printWindow.document.write(`
    ...
    <head>
      ...
      <style>
        * { box-sizing: border-box; }
        ...
        @media print {
          /* Force physical printing metrics to clip tightly against absolute point frames */
    ...
    <body>
      ...
      <script>
        // Wait for cross-origin local background data to load completely before executing the system print
